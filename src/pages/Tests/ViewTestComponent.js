...
import { GetTestDetailsByIdAPI } from '../../helpers/APIs/CommonAPIs';
import { getTestDetailsByIdURL } from '../../helpers/APIs/CustomURL';
...
const ViewTestComponent = () => {
    ...
    useEffect(() => {
        callAPIAction(GetTestDetailsByIdAPI, getTestDetailsByIdURL(testId));
    }, []);
                ...
                <div className="px-10 pt-5">
                    ...
                    <Row>
                        <Col xs={12} sm={12} md={6} lg={6} xl={6} xxl={6}>
                            <Row className="mb-3">
                                <Col xs={3} sm={3} md={3} lg={3} xl={3} xxl={3} className="fs-16 text-muted">
                                    No.of tests
                                </Col>
